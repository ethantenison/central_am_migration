...
coords <- data.frame("long" =c(-90.4,-98.8,-86.5,-86.94,-89.4,-85.3,-87.8,-79.55,-78.56,-77.36),
                "lat" = c(15.3,18.9,17.1,14.78,12.6,12.66,9.88,10.5,23.8,17.12),
...
ggplot(data = Comar_Budget_App) + 
   theme(legend.background = element_rect(fill = "transparent"), 
         ...
         axis.title.y.left = element_text(color = "#0D0887FF"),
          legend.position = "bottom")+
   geom_bar(aes(x=year, y=refugee_status_applications_submitted),stat="identity", fill="#0D0887FF",width = .5) +
