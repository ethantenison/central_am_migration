...
p <- ggplot(commodities, aes(x = year, y=value, color = Commodity)) + 
   ...
   theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(),panel.background = element_blank(), axis.line = element_line(colour = "black")) +labs(caption = "Data source: The World Bank") + 
   scale_color_manual(values = plasma_pal) + 
   xlab("Year") +
   ylab("Real Prices (Adjusted for Inflation)") +
   scale_y_continuous(labels = scales::dollar)

p + facet_wrap(~Commodity, scale = "free") + theme(strip.background =element_rect(fill="white"))
