...
ggsave("inm_apprehensions_amlo.png")

```


# INM total Apprehensions Dec 2019 - feb 2020


```{r total_apprehensions }
...
apps_amlo <- read_csv("INM Apprehensions AMLO Pres.csv")
data_long <- gather(apps_amlo, Date, Apprehensions, "2018-12-01":"2020-02-01", factor_key=TRUE)
data_long <- filter(data_long, Country == "Total")
data_long$Date <- as.character(data_long$Date)
data_long$Date <- as.Date(data_long$Date)
...
ggsave("inm_apprehensions_amlo_total.png", width = 14, height = 7, units = "in")


```


# Total Apprehensions from 2001


```{r all_apprehensions_2011onwards}
...
ggsave("inm_apprehensions_amlo_total_from2011.png", width = 14, height = 7, units = "in")
