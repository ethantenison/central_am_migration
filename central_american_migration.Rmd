...
ggsave("commodity_prices.png", dpi = "retina" )
```
...
library(lubridate)
library(readxl)
windowsFonts(Times=windowsFont("Georgia"))
...
ggplot(data = total_humanitarian_visas, aes(x = Date, y = Number_of_Visas)) +
   ...
   ylab("Humanitarian Visas Issued") +
   #labs(caption = "Source: INM Transparency Request")
ggsave("total_humanitarian_visas.png", width =14, height = 7,dpi = "retina" )
...
data_long <- data_long %>% filter(Country == "Total") %>% filter(Date >= as.Date("2019-03-01"))
plasma_pal <- c("#7E03A8FF") # "#0D0887FF", "#F89441FF", "#CC4678FF"
windowsFonts(Times=windowsFont("Georgia"))
...
ggplot(data = data_long) +
   ...
   xlab("Date") +
   ylab("Apprehensions") 
ggsave("inm_apprehensions_amlo.png", height = 7, width = 20, dpi = "retina")
