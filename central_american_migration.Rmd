...
>>>>>>> 746c1ab59b97f7a1fc9c6d017e43661bcfaa4fa4
list.of.packages <- c(
   "ggplot2",
   "dplyr",
   "tidyverse", 
...
(ggulf <- ggplot(data = world) +
      ...
      theme( axis.title.x = element_blank(), 
            ...
            panel.border = element_rect(fill = NA), text=element_text(family="Georgia", face = "bold", size=12),plot.title = element_text(hjust = 0.5))+
      ...
      annotate(geom = "text", x = -91.7, y = 32.26, label = "$62,795", 
               color = "white", size = 4) +
      labs(fill = "GDP Per capita, PPP", title = "GDP Per Capita in Central America")) 
...
<<<<<<< HEAD
shortened <- filter(Humanitarian_Visa_Graph, date >= as.Date("2018-12-01") & date <= as.Date("2019-05-01"))
=======
...
>>>>>>> 746c1ab59b97f7a1fc9c6d017e43661bcfaa4fa4
theme_set(theme_bw())
ggplot(data = shortened, aes(x = date, y = count_mea)) +
   theme(
         panel.background = element_blank(),
         axis.line = element_line(colour = "black"),
<<<<<<< HEAD
...
>>>>>>> 746c1ab59b97f7a1fc9c6d017e43661bcfaa4fa4
   ...
   xlab("Date") +
   ylab("Humanitarian Visas Issued")
ggsave("humanitarian_visas_shortened.png", width = 15, height = 5)
```
<<<<<<< HEAD
### COMAR Funding 
=======
...
ggplot(data = Comar_Budget_App, aes(x=year, y=refugee_status_applications_submitted, fill=apps)) + 
   ...
   #labs(caption = "Source: COMAR", title = "COMAR Funding and Refugee Applications") +
    geom_segment(aes(
      x = 2014,
      y = 88000,
      xend = 2013.2,
...
ggsave("inm_complaints.png", width =8, height = 5)
```
...
ggsave("price_hiring_guide.png", width = 8, height = 5)
```
<<<<<<< HEAD
=======
...
ggplot(data = contratoguia) +
   ...
   geom_text(aes(x= Year, y = adj_perc, label=perch))+
   ylim(40, 65) +
   scale_x_continuous(breaks = c(2011,2012,2013,2014,2015,2016,2017,2018,2019)) +
   xlab("Year") +
   ylab("Hired a Guide (%)") +
  # labs(caption = "Source: COLEF", title = "Percent of Migrants that Hired a Guide")
ggsave("hired_guide.png", width = 8, height = 5)
```
<<<<<<< HEAD
# Number of INM Employees 
=======
...
inm_emp<- inm_emp %>% dplyr::group_by(State) %>% summarise(number_agents = sum(number))
...
>>>>>>> 746c1ab59b97f7a1fc9c6d017e43661bcfaa4fa4
ggplot() +
   geom_sf(data = df_mxstate, aes(fill = number_agents), size = .3) +
   theme_map() +
   scale_fill_viridis(option = "plasma", direction = 1) +
      theme( axis.title.x = element_blank(), 
   ...
   labs( fill = "Number of Agents") # title = "Number of Mexican Migration Officials by State" caption = "Source: INM Transparency Request",
<<<<<<< HEAD
ggsave("number_agents.png")   
```
...
ggplot() +
   ...
   labs(fill = "Number of Complaints") # title = "Crimes Against Migrants Committed by Authorities by State" caption = "Source: CNDH Transparency Request",
<<<<<<< HEAD
ggsave("number_complaints.png")   
```
